...
#    Updated: 2022/02/10 16:36:47 by oleg             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_GAME = main.c preparation.c render.c init.c utils.c map_check.c input.c patrol_init.c patrol.c game_over.c win.c menu.c lvl_select.c sprites.c
