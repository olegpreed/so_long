...
SRC_GAME = main.c preparation.c display*.c render.c init.c move.c utils.c utils2.c map_check.c input.c patrol_init.c patrol.c patrol_move.c game_over.c win.c menu.c lvl_select.c lvl_name.c sprites.c
